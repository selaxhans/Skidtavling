...
public class Participants extends Person {
	...
	private int place;
	/*
	 * Tid /hast mm i det simulerade loppet är tidräkningen baserad på enheten 15 sekunder
	 * och hast är den sträcka löparen hinner på 15 sek. all tid räknas således i
	 * 15 sekunders steg;  
	 * 
	 */
	...
	public int startTime;	//  redefined to run time  
	...
	public Participants(int participantNumber, String forName, String lastName, int place, int startTime, int middletime, String indivStarTime, int distance,
	...
	public String toString() 
	{
		...
		return participantNumber + " " + forName + " " + lastName + "" + "\t place=" + place + " :  " + startTime + "  :  "+ middleTime  
					+ " har kommit : " + distance + "\tutgått " + arUtgatt;
